...
accepted by the developer before the next began. All phases so far were built on 23 September 2026 in one long
...
| 7 | Experiments and results | awaiting review | P2 3.4 false incidents/month (P0 340.6); every ablation raises false alarms; dial 46–67 min median; spacing 63/33/5% confirmed; detection gap to the report traced to haze in calibration windows | [phase-7-experiments.md](phase-7-experiments.md) |
