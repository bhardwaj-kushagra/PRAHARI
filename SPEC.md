...
- Every equation in code cites its §5 equation number in a comment: `# M17 — QCC p-value`.
...
| cusum | Fixed h from the ARL formula (M21) | Single-sample threshold |
...
{"trace_id": "d-840-1", "t": 840, "type": "decision", "level": "CONFIRMED",
 "cluster": [17, 18, 27],
 "per_node": [{"node": 18, "p_channels": [0.0004], "health": [1.0], "cusum": 96.0, "h": 218.7}],
 "scmr": {"f_loc": 0.33, "f_net": 0.03, "ratio": 11.0, "pass": true},
 "fisher": {"X": 29.1, "dof": 4, "p_cluster": 7.4e-6},
 "prior": {"lambda": 3.1e-6, "p_s": 0.62, "pi": 1.9e-6, "odds": 1.9e-6},
 "bayes": {"bf_bound": 5200, "posterior_odds": 0.0099, "threshold": 0.01, "decision": true},
 "explanation": "3 of 9 neighbours raised candidates within 30 min; local rate 11x the network rate; posterior odds 0.0099 met the 0.01 threshold for a dry, busy day."}
```
